...
function M.setup()
	...
	local groups = {
		...
		CursorLine                 = { bg = palette.darkest }, -- Screen-line at the cursor, when 'cursorline' is set.  Low-priority if foreground (ctermfg OR guifg) is not set.
		...
		-- TermCursor   = { fg = palette.yellow }, -- cursor in a focused terminal
		...
		Pmenu                      = { bg = palette.background, fg = palette.light },           -- Popup menu: normal item.
		PmenuSel                   = { bg = palette.pink_accent2, fg = palette.orange, bold = true }, -- Popup menu: selected item.
		...
		Whitespace                 = { fg = palette.background_alt }, -- "nbsp", "space", "tab" and "trail" in 'listchars'
		...
		Constant                   = { fg = palette.yellow_accent },        -- (preferred) any constant
		...
		Identifier                 = { fg = palette.red },                  -- (preferred) any variable name
		Function                   = { fg = palette.red },                  -- function name (also: methods for classes)
		...
		Macro                      = { fg = palette.purple_accent, bold = true }, --    same as Define
		...
		Delimiter                  = { fg = palette.red },                  --  character that needs attention
		...
		DiagnosticError            = { fg = palette.pink_accent2 },                     -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
		...
		DiagnosticInfo             = { fg = palette.yellow_accent },                    -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
		DiagnosticHint             = { fg = palette.purple_accent },                    -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
		DiagnosticVirtualTextError = { fg = palette.pink_accent2 },                     -- Used for "Error" diagnostic virtual text.
		DiagnosticVirtualTextWarn  = { fg = palette.orange_accent },                    -- Used for "Warn" diagnostic virtual text.
		DiagnosticVirtualTextInfo  = { fg = palette.yellow_accent },                    -- Used for "Info" diagnostic virtual text.
		DiagnosticVirtualTextHint  = { fg = palette.purple_accent },                    -- Used for "Hint" diagnostic virtual text.
		--[[ DiagnosticUnderlineError    = { sp = palette.red_accent, undercurl = true },     -- Used to underline "Error" diagnostics.
		DiagnosticUnderlineWarn     = { sp = palette.orange_accent, undercurl = true },  -- Used to underline "Warn" diagnostics.
		DiagnosticUnderlineInfo     = { sp = palette.cyan, undercurl = true },           -- Used to underline "Info" diagnostics.
		DiagnosticUnderlineHint     = { sp = palette.blue_accent, undercurl = true },    -- Used to underline "Hint" diagnostics. ]]
		DiagnosticUnderlineError = { sp = palette.pink_accent2, underline = true }, -- Used to underline "Error" diagnostics.
		DiagnosticUnderlineWarn  = { sp = palette.orange_accent, underline = true }, -- Used to underline "Warn" diagnostics.
		DiagnosticUnderlineInfo  = { sp = palette.yellow_accent, underline = true }, -- Used to underline "Info" diagnostics.
		DiagnosticUnderlineHint  = { sp = palette.purple_accent, underline = true }, -- Used to underline "Hint" diagnostics.
		-- DiagnosticFloatingError    = { }, -- Used to color "Error" diagnostic messages in diagnostics float. See |vim.diagnostic.open_float()|
		-- DiagnosticFloatingWarn     = { }, -- Used to color "Warn" diagnostic messages in diagnostics float.
		-- DiagnosticFloatingInfo     = { }, -- Used to color "Info" diagnostic messages in diagnostics float.
		-- DiagnosticFloatingHint     = { }, -- Used to color "Hint" diagnostic messages in diagnostics float.
		DiagnosticSignError      = { fg = palette.pink_accent }, -- Used for "Error" signs in sign column.
		DiagnosticSignWarn       = { fg = palette.orange_accent }, -- Used for "Warn" signs in sign column.
		DiagnosticSignInfo       = { fg = palette.yellow_accent }, -- Used for "Info" signs in sign column.
		DiagnosticSignHint       = { fg = palette.purple_accent }, -- Used for "Hint" signs in sign column.

		-- These groups are for tree-sitter:

		-- DEBUG HERE --
		-- ['@debug']              = { fg = palette.red_accent }, -- Annotations that can be attached to the code to denote some kind of meta information. e.g. C++/Dart attributes.
		...
		['@constant.builtin']       = { fg = palette.cyan },    -- Built-in constant values: `nil` in Lua.
		-- ["@constant.macro"]         = { }, -- Constants defined by macros: `NULL` in C.
		['@constructor']            = { fg = palette.green_accent2 }, -- Constructor calls and definitions: `= {}` in Lua, and Java constructors.
		...
		['@function.builtin']       = { fg = palette.cyan }, -- Built-in functions: `print` in Lua.
		['@function.macro']         = { fg = palette.cyan }, -- Macro defined functions (calls and definitions): each `macro_rules` in Rust.
		['@function.method.call']   = { fg = palette.cyan }, -- Macro defined functions (calls and definitions): each `macro_rules` in Rust.

		-- ["@include"]            = { }, -- File or module inclusion keywords: `#include` in C, `use` or `extern crate` in Rust.
		['@keyword']                = { fg = palette.green_accent3 }, -- Keywords that don't fit into other categories.
		-- ["@keyword.function"]    = { fg = palette.cyan2 }, -- Keywords used to define a function: `function` in Lua, `def` and `lambda` in Python.
		["@keyword.operator"]       = { fg = palette.pink_accent2 }, -- Unary and binary operators that are English words: `and`, `or` in Python; `sizeof` in C.
		-- ["@keyword.return"]      = { }, -- Keywords like `return` and `yield`.
		['@label']                  = { fg = palette.yellow },  -- GOTO labels: `label:` in C, and `::label::` in Lua.
		-- ["@method"]             = { }, -- Method calls and definitions.
		['@namespace']              = { fg = palette.green_accent3 }, -- Identifiers referring to modules and namespaces.
		...
		["@operator"]               = { fg = palette.red }, -- Binary or unary operators: `+`, and also `->` and `*` in C.
		...
		['@string']                 = { fg = palette.yellow2 }, -- String literals.
		...
		['@class']                  = { fg = palette.cyan3 },   -- Built-in types: `i32` in Rust.
		['@interface']              = { fg = palette.cyan3 },   -- Built-in types: `i32` in Rust.
		['@danger']                 = { fg = palette.red_error }, -- Text representation of a danger note.
		['@type']                   = { fg = palette.green_accent2 }, -- Type (and class) definitions and annotations.
		['@type.identifier']        = { fg = palette.cyan3 },   -- Built-in types: `i32` in Rust.
		['@type.class']             = { fg = palette.cyan3 },   -- Built-in types: `i32` in Rust.
		['@type.typeParameter']     = { fg = palette.cyan3 },   -- Built-in types: `i32` in Rust.
		['@type.annotation']        = { fg = palette.cyan3 },   -- Built-in types: `i32` in Rust.
		['@type.interface']         = { fg = palette.cyan3 },   -- Built-in types: `i32` in Rust.
		['@type.qualifier']         = { fg = palette.cyan },    -- Type (and class) definitions and annotations.
		...
		['@variable.member']        = { fg = palette.purple_accent }, -- Variable names that don't fit into other categories.
		['@variable.builtin']       = { fg = palette.red },     -- Variable names defined by the language: `this` or `self` in Javascript.
		...
		LspInlayHint                = { fg = palette.inlay_hint },
		...
		CmpDocumentation         = { fg = palette.fg, bg = palette.bg_float },
		CmpDocumentationBorder   = { fg = palette.border_highlight, bg = palette.bg_float },

		CmpItemAbbr              = { fg = palette.fg, bg = palette.none },
		CmpItemAbbrDeprecated    = { fg = palette.fg_gutter, bg = palette.none, strikethrough = true },
		CmpItemAbbrMatch         = { fg = palette.blue1, bg = palette.none },
		CmpItemAbbrMatchFuzzy    = { fg = palette.blue1, bg = palette.none },

		CmpItemMenu              = { fg = palette.comment, bg = palette.none },
		CmpItemKindDefault       = { fg = palette.fg_dark, bg = palette.none },
		CmpItemKindKeyword       = { fg = palette.cyan, bg = palette.none },

		CmpItemKindVariable      = { fg = palette.magenta, bg = palette.none },
		CmpItemKindConstant      = { fg = palette.magenta, bg = palette.none },
		CmpItemKindReference     = { fg = palette.red, bg = palette.none },
		CmpItemKindValue         = { fg = palette.yellow2, bg = palette.none },
		CmpItemKindCopilot       = { fg = palette.teal, bg = palette.none },

		CmpItemKindFunction      = { fg = palette.blue, bg = palette.none },
		CmpItemKindMethod        = { fg = palette.blue, bg = palette.none },
		CmpItemKindConstructor   = { fg = palette.blue, bg = palette.none },
		CmpItemKindClass         = { fg = palette.orange, bg = palette.none },
		CmpItemKindInterface     = { fg = palette.orange, bg = palette.none },
		CmpItemKindStruct        = { fg = palette.orange, bg = palette.none },
		CmpItemKindEvent         = { fg = palette.orange, bg = palette.none },
		CmpItemKindEnum          = { fg = palette.orange, bg = palette.none },
		CmpItemKindUnit          = { fg = palette.orange, bg = palette.none },

		CmpItemKindModule        = { fg = palette.yellow, bg = palette.none },

		CmpItemKindProperty      = { fg = palette.green_accent2, bg = palette.none },
		CmpItemKindField         = { fg = palette.green_accent2, bg = palette.none },
		CmpItemKindTypeParameter = { fg = palette.green_accent2, bg = palette.none },
		CmpItemKindEnumMember    = { fg = palette.green_accent2, bg = palette.none },
		CmpItemKindOperator      = { fg = palette.green_accent2, bg = palette.none },
		CmpItemKindSnippet       = { fg = palette.pink_accent2, bg = palette.none },

		CmpItemKindText          = { fg = palette.red_accent, bg = "#9FBD73" },
		CmpItemKindFile          = { fg = "#C5CDD9", bg = "#7E8294" },
		CmpItemKindFolder        = { fg = "#F5EBD9", bg = "#D4A959" },
		CmpItemKindColor         = { fg = "#D8EEEB", bg = "#58B5A8" },

		TelescopeBorder          = { fg = palette.background_alt, bg = palette.background },
		TelescopeNormal          = { bg = palette.background },
		TelescopeSelection       = { fg = palette.yellow2, bg = palette.pink_accent },
		TelescopeSelectionCaret  = { fg = palette.pink_accent },
		TelescopeMultiSelection  = { fg = palette.green2 },
		TelescopePreviewBorder   = { fg = palette.background_alt, bg = palette.background_alt },
		TelescopePreviewTitle    = { fg = palette.orange, bg = palette.green_accent },
		TelescopePreviewNormal   = { fg = palette.light, bg = palette.background_alt },
		TelescopePromptBorder    = { fg = palette.background_alt, bg = palette.background_alt },
		TelescopePromptNormal    = { fg = palette.fg, bg = palette.background_alt },
		TelescopePromptPrefix    = { fg = palette.pink_accent, bg = palette.background_alt },
		TelescopePromptTitle     = { fg = palette.yellow2, bg = palette.pink_accent },
		TelescopeResultsBorder   = { fg = palette.background, bg = palette.background },
		TelescopeResultsTitle    = { fg = palette.background, bg = palette.background },

		GitSignsAdd              = { fg = palette.green_accent },
		GitSignsChange           = { fg = palette.yellow_accent },
		GitSignsDelete           = { fg = palette.red_accent },
